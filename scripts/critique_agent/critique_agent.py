...
async def analyze_chapter_critique(chapter: Chapter, previous_chapters: List[Chapter] = None) -> Optional[str]:
...
async def save_critique_analysis(book: Book, chapter: Chapter, critique_text: str) -> Optional[Path]:
    try:
