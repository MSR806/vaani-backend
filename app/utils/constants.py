...
class SettingKeys(Enum):
    ...
    CHAPTER_SUMMARY_GENERATION_FROM_STORYBOARD_MODEL = "chapter_summary_generation_from_storyboard_model"
    CHAPTER_SUMMARY_GENERATION_FROM_STORYBOARD_TEMPERATURE = "chapter_summary_generation_from_storyboard_temperature"
    
    CHAPTER_SUMMARY_GENERATION_FOR_TEMPLATE_MODEL = "chapter_summary_generation_for_template_model"
    CHAPTER_SUMMARY_GENERATION_FOR_TEMPLATE_TEMPERATURE = "chapter_summary_generation_for_template_temperature"
